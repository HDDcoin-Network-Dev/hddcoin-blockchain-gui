...
const HODL_HELP_PATH = `${
  process.env[process.platform === 'win32' ? 'USERPROFILE' : 'HOME']
}/.chia/mainnet/hodl/hodlhelp.txt`;
const fullPath = existsSync(
  process.platform === 'win32' ? path.join(__dirname, PY_WIN_DIST_FOLDER) : path.join(__dirname, PY_MAC_DIST_FOLDER)
)
  ? process.platform === 'win32'
    ? path.join(__dirname, PY_WIN_DIST_FOLDER)
    : path.join(__dirname, PY_MAC_DIST_FOLDER)
